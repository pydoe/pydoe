...
def fracfact_by_res(n: int, res: int) -> np.ndarray:
    """
    Build a 2-level fractional factorial design with a target resolution.
    ...
    -------
    np.ndarray
        Design matrix generated by `fracfact`.

    Raises
    ------
    ValueError
        If inputs are invalid or the requested design is not feasible.
    """
    if n < 2:
...
def _get_base_factors_from_table(n: int, res: int) -> int | None:
    ...
    table = {
        ...
        (3, 3): 2,
        (4, 3): 3, (5, 3): 3, (6, 3): 3,
        (7, 3): 4, (8, 3): 4, (9, 3): 4, (10, 3): 4,
        (11, 3): 4, (12, 3): 4, (13, 3): 4, (14, 3): 4, (15, 3): 4,

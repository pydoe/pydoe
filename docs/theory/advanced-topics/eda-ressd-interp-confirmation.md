# Motivation: Interpolation Confirmation
...
and is computed by substituting the values $X_1$ = +2.0
($T$=375) and $X_2$ = +0.8 ($t$=28) into the prediction
equation

![Yhat = 5 + (1/2)(4*X2 + 2*X1 + 0*X1*X2)](https://www.itl.nist.gov/div898/handbook/pri/section5/eqns/yhatmod3.gif)
